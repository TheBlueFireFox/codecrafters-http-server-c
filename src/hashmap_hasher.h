...
typedef Hash (*HashMapContextOneShot)(void *config, const void *data,
                                      size_t size);
...
#define HASHMAP_ONE_SHOT_FOR(type, algo)                                       \
  _Generic((type),                                                             \
      HASHMAP_FULL_INTEGER_TYPES(HASHMAP_ONESHOT_CASE,                         \
                                 algo) default: &hashmap_unsupported_key_type)
