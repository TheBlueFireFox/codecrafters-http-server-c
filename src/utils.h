...
#endif
static inline void
log_impl(enum Level level, const char* file, int line, const char* func, const char* fmt, ...) {
...
#define log(level, fmt, ...)                                                                       \
    log_impl((level), __FILE_NAME__, __LINE__, __func__, (fmt)__VA_OPT__(, ) __VA_ARGS__)
