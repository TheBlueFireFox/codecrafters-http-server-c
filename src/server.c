...
static void
send_task(int client_fd, AppState* state, atomic_bool* server_running, ThreadPool* pool) {
...
static int server_loop(int fd, AppState* state, ThreadPool* pool, atomic_bool* is_running) {
